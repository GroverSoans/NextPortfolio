...
export default function Home() {
  ...
  const handleDownload = () => {
    window.open('/resume/GroverSoansResumeUpdated.pdf', '_blank');
  };
        ...
        <div className={`transition-all duration-500 ${!isNavOpen ? 'lg:pr-96' : 'lg:pr-16'}`}>
          <div className="h-screen flex flex-col justify-center px-6 md:pl-20 pb-32 z-30">
            ...
            <Button 
              ...
              className="relative z-20 w-fit flex items-center gap-2 bg-light-primary hover:bg-light-secondary text-white"
            >
